...
class ParserTests {
    ...
    @Test func parseSample2() throws {
        let xmp = try XMPDynamicMedia(xml: sample(named: "sample2.xml"))
        #expect(xmp.duration == 3.52)
    }

    @Test func parseSample4() throws {
        let xmp = try XMPDynamicMedia(xml: sample(named: "sample4.xml"))
    ...
    @Test func parseSample8() throws {
        let xmp = try XMPDynamicMedia(xml: sample(named: "sample8.xml"))
